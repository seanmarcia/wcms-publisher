module SetModifier
  ...
  def assign_modifier
    ...
    [:actor, :attachment, :audience_collection, :calendar, :campus_location, :feature_location, :important_date, :menu, :page_edition, :publisher, :service_link, :site_category, :site].each do |name|
