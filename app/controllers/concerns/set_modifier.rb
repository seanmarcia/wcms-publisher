module SetModifier
  ...
  def assign_modifier
    ...
    [:actor, :attachment, :audience_collection, :calendar, :campus_location, :feature_location, :important_date, :medium, :menu, :page_edition, :publisher, :service_link, :site_category, :site, :photo_gallery, :presentation_data_template, :event, :event_collection].each do |name|
