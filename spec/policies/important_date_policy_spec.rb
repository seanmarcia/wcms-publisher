require 'spec_helper'
describe ImportantDatePolicy do
  subject { described_class } # describe class uses the parent describe class: ImportantDatePolicy
  ...
  describe "can_manage?" do
    subject { ImportantDatePolicy.new(user, important_date) }
    let(:important_date) { build :important_date }
    let(:user) { build :user, attrs }
