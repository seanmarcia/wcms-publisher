class PageEditionPolicy < PermissionsPolicy
  ...
  def permitted_attributes
    attrs = [:title, :slug, :site_id, :body, :page_template, attachment_ids: [], department_ids: [], audience_collection: [affiliations: [], schools: [], student_levels: [], class_standings: [], majors: [], housing_statuses: [], employee_types: [], departments: []]]
